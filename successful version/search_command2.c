...
#include <fcntl.h>
/**
 * srch_cmnd - Search for a command in the specified directories.
 * @array: Command to search for.
 * @directory: Array of directories to search in.
 * Return: return the full path or null
 */
